...
advanced_expl_div = $(
  '<div id="permdialog_advanced_explantion_text">For special permissions or advanced settings, click More.</div>'
);
...
perm_dialog.append(
  $(
    '<div id="permissions_user_title"><strong>Select a group or user to make permission edits<strong></div>'
  )
);
